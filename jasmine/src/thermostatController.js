$( document ).ready(function(){
  ...
  $.getJSON("http://api.openweathermap.org/data/2.5/weather?q=London&units=metric&APPID=a473b14fcbf6d200f1c102de58640d2f",function(json) {$('#weather').text(json.main.temp);});
